...
const steps = [
  ...
  },
  {
    ...
    description: 'Meet the performance targets — and get invited to our funded program.',
    icon: (
      <svg width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M56.375 41.25C63.2096 41.25 68.75 35.7096 68.75 28.875C68.75 22.0405 63.2096 16.5 56.375 16.5C49.5404 16.5 44 22.0405 44 28.875C44 35.7096 49.5404 41.25 56.375 41.25Z" fill="url(#paint0_linear_0_284)" />
        <path d="M82.2255 45.375C81.6755 44.55 80.8505 44 79.7505 44C73.7005 44 67.9255 46.75 64.3505 51.7L61.8755 55C58.8505 58.575 54.1755 60.5 49.5005 60.5H41.2505C39.6005 60.5 38.5005 59.4 38.5005 57.75C38.5005 56.1 39.6005 55 41.2505 55H46.4755C50.8755 55 55.0005 51.425 55.0005 47.025V46.75C55.0005 45.375 53.6255 44 52.2505 44H35.4755C25.5755 44 17.6005 48.4 13.2005 55.55L5.77554 67.1C5.22554 67.925 5.22554 69.025 5.77554 69.85L14.0255 83.6C14.3005 84.15 15.1255 84.7 15.6755 84.975C15.9505 84.975 15.9505 84.975 16.2255 84.975C16.7755 84.975 17.3255 84.7 17.8755 84.425C28.3255 77.55 40.4255 73.975 52.8005 73.975C61.8755 73.975 70.1255 69.025 74.5255 61.05L81.9505 47.85C82.5005 47.3 82.5005 46.2 82.2255 45.375Z" fill="url(#paint1_linear_0_284)" />
        <path d="M38.5 28.875C38.5 22 42.625 15.95 48.4 12.925C46.475 8.525 42.075 5.5 37.125 5.5C30.25 5.5 24.75 11 24.75 17.875C24.75 24.75 30.25 30.25 37.125 30.25C37.675 30.25 37.95 30.25 38.5 29.975C38.5 29.7 38.5 29.425 38.5 28.875Z" fill="url(#paint2_linear_0_284)" />
        <defs>
          <linearGradient id="paint0_linear_0_284" x1="57.5267" y1="41.25" x2="77.7359" y2="27.4892" gradientUnits="userSpaceOnUse">
            <stop stop-color="#00C76E" stop-opacity="0.5" />
            <stop offset="0.756838" stop-color="#00C76E" />
            <stop offset="1" stop-color="#00C76E" stop-opacity="0.5" />
          </linearGradient>
          <linearGradient id="paint1_linear_0_284" x1="47.4691" y1="84.975" x2="82.3581" y2="40.3073" gradientUnits="userSpaceOnUse">
            <stop stop-color="#00C76E" stop-opacity="0.5" />
            <stop offset="0.756838" stop-color="#00C76E" />
            <stop offset="1" stop-color="#00C76E" stop-opacity="0.5" />
          </linearGradient>
          <linearGradient id="paint2_linear_0_284" x1="37.6753" y1="30.25" x2="57.5333" y2="17.3295" gradientUnits="userSpaceOnUse">
            <stop stop-color="#00C76E" stop-opacity="0.5" />
            <stop offset="0.756838" stop-color="#00C76E" />
            <stop offset="1" stop-color="#00C76E" stop-opacity="0.5" />
          </linearGradient>
    ...
    <section id="how-it-works" className="pb-24">
      <div className="max-w-6xl mx-auto px-4 lg:px-0">
        ...
        <div className="grid gap-16 lg:grid-cols-12 items-start">
          <div className="lg:col-span-6 space-y-10 text-white mt-4">
              ...
              {steps.map((step) => (
                <div key={step.title} className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="mt-2 font-inter text-white/80 text-[18px] mx-auto">{step.description}</p>
                  </div>
                </div>
              ))}

              <p className="text-sm font-inter text-[16px] text-white/70 flex items-start gap-2 pl-[10px]">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <Image
              ...
              className="relative rounded-[40px] border border-white/10 shadow-card h-[530px] w-full object-cover"
            />
          </div>
        </div>
      </div>
